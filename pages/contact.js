          ...
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-4s">
                ...
                <div className="content">
                  <h4>Location</h4>
                  <span> H.no 4072, sec 32, Shusant city, Kurukshetra, Haryana</span>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="contact-info-item wow fadeInUp delay-0-6s">
                ...
                <div className="content">
                  <h4>Phone Us</h4>
                  <a href="callto:8570031091">8570031091</a>
                  <br />
                  <a href="callto:9050546746">9050546746</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="contact-right-image wow fadeInRight delay-0-4s">
                <img
                  src="assets/images/contact/contactSide2.png"
                  alt="Contact From"
                />
                <img
                  className="bg"
