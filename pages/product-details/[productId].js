...
const ProductDetails = () => {
  ...
  useEffect(() => {
    if (productId) { 
      const searchProductDetails = () => {
        ...
        const filteredProduct = storedProducts.find(product => product.id === Number(productId)); // Convert productId to Number
  ...
  const addToCart = (id, quantity,product_name,image,price) => {
  ...
  const handleSubmit = (e,id) => {
    e.preventDefault();
    addToCart(id, quantity,product.product_name,product.image,product.Price);
  };
              ...
              <div className="product-details-content mb-30 wow fadeInRight delay-0-2s">
                ...
                <div className="custom-reviews-main">
                  <div className="custom-reviews-main-svg review-first">
                    ...
                    <div>
                      <p className="custom-average-number ml-2 mb-0">{product.rating}</p>
                    </div>
                  </div>
